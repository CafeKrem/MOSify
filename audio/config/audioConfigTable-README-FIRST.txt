...
begin with the audioConfigTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : audioConfigTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f audioConfigTable_Makefile


  File    : audioConfigTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   audioConfigTable-README-audioConfigTable.txt
...
------------------------------------------------------------------------
  ...
  File    : audioConfigTable_interface.c
